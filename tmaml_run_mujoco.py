from meta_policy_search.baselines.linear_baseline import LinearFeatureBaseline, MetaNNBaseline, LinearTimeBaseline
...
def main(config):
    ...
    return_baseline = LinearFeatureBaseline() # the additional baseline for DICE

    env = globals()[config['env']]() # instantiate env
    env = normalize(env) # apply normalize wrapper to env

    meta_baseline = MetaNNBaseline(input_size=env.observation_space.shape[0]) # the meta baseline
